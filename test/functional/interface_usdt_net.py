...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/monacoin/monacoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MonacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our monacoind node")
