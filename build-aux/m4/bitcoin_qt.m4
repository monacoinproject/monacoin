...
AC_DEFUN([MONACOIN_QT_FAIL],[
  if test "$monacoin_qt_want_version" = "auto" && test "$monacoin_qt_force" != "yes"; then
    if test "$monacoin_enable_qt" != "no"; then
...
AC_DEFUN([MONACOIN_QT_CHECK],[
  if test "$monacoin_enable_qt" != "no" && test "$monacoin_qt_want_version" != "no"; then
    true
    $1
  else
    true
...
AC_DEFUN([MONACOIN_QT_INIT],[
  ...
  AC_ARG_WITH([gui],
    ...
    [
     ...
     if test "$monacoin_qt_want_version" = "yes"; then
...
AC_DEFUN([MONACOIN_QT_CONFIGURE],[
  ...
  if test "$monacoin_cv_static_qt" = "yes"; then
  ...
  if test $monacoin_enable_qt = "yes"; then
