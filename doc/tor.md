...
Monacoin Core automatically creates an onion service to listen on. This will positively
...
- Do not add anything but Monacoin Core ports to the onion service created in section 2.
