...
Every single pull request submitted against the Monacoin Core repo is automatically tested against all inputs in the [`monacoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitcoin Core more robust.
