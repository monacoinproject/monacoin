Monacoin Core version 0.16.1 is now available from:

  <https://monacoincore.org/bin/monacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting monacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure monacoind processes are cleaned up when tests end (sdaftuar)
