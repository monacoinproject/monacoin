Monacoin Core version 0.9.2 is now available from:

  https://monacoin.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 MONA to 0.01 MONA
...
- Fix "Start monacoin on system login"
