Monacoin Core version 0.14.1 is now available from:

  <https://monacoin.org/bin/monacoin-core-0.14.1/>
...
here:
[reducing-monacoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` monacoin-tx input verification (awemany, jnewbery)
