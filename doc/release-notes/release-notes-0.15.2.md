Monacoin Core version *0.15.2* is now available from:

  <https://monacoincore.org/bin/monacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in monacoin-tx (TheBlueMatt)
