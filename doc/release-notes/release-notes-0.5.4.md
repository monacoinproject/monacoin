Monacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/monacoin/files/Monacoin/monacoin-0.5.4/
...
http://gitorious.org/monacoin/monacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Monacoin-Qt notifications under Growl 1.3.
Increase required age of Monacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMonacoin properly when installing Monacoin-Qt over it. (Windows)
