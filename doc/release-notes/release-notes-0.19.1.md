...
Monacoin Core version 0.19.1 is now available from:

  <https://monacoincore.org/bin/monacoin-core-0.19.1/>
...
From Monacoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Monacoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Monacoin Core does not yet change appearance when
...
- #17488 fix "monacoind already running" warnings on macOS (fanquake)
