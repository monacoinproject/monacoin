Monacoin Core version 0.14.2 is now available from:
  ...
  <https://monacoin.org/bin/monacoin-core-0.14.2/>
...
(in Monacoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Monacoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate monacoin-config.h as necessary (theuni)
