Monacoin Core version 0.10.4 is now available from:

  <https://monacoin.org/bin/monacoin-core-0.10.4/>
...
- #6953 `43c2789` Split monacoin-tx into its own package
- #6953 `dfe0d4d` Include monacoin-tx binary on Debian/Ubuntu
