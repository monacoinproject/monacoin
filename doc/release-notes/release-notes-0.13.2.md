Monacoin Core version 0.13.2 is now available from:
  ...
  <https://monacoin.org/bin/monacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update monacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow monacoin-tx to create v2 transactions (btcdrak)
