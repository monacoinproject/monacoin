...
**Failure consideration:** if monacoind unexpectedly halts after `m_stop_use` is set on
...
When monacoind initializes again, what began as the snapshot chainstate is now
