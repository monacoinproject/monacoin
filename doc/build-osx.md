...
1. Clone the Monacoin Core source code:
...
The first time you run monacoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
