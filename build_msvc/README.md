...
Qt
---------------------
In order to build the Monacoin Core a static build of Qt is required. The runtime library version (e.g. v141, v142) and platform type (x86 or x64) must also match.
...
To build Monacoin Core without Qt unload or disable the `monacoin-qt`, `libbitcoin_qt` and `test_monacoin-qt` projects.
