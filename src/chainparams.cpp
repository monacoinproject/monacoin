...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.monacoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.monacointools.com", true);
        vSeeds.emplace_back("dnsseed.monacoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.monacointools.com", true);
        vSeeds.emplace_back("seed-b.monacoin.loshan.co.uk", true);
