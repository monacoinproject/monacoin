...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.monacoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("monacointools.com", "dnsseed.monacointools.com"));
        vSeeds.push_back(CDNSSeedData("monacoinpool.org", "dnsseed.monacoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("monacointools.com", "testnet-seed.monacointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.monacoin.loshan.co.uk", true));
