...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Monacoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  monacoind [options]                     " + _("Start Monacoin Core Daemon") + "\n";
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in monacoind anymore. Use the monacoin-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
