...
"end\n"
"\n"
"socket.sinkt[\"http-chunked2\"] = function(sock, headers)\n"
"end\n"
"-----------------------------------------------------------------------------\n"
...
int luaopen_lua_m_ltn12(lua_State *L) {
    return luaL_loadstring(L, lua_m_ltn12);
}


int luaopen_lua_m_mime(lua_State *L) {
    return luaL_loadstring(L, lua_m_mime);
}


int luaopen_lua_m_socket_ftp(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_ftp);
}


int luaopen_lua_m_socket_headers(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_headers);
}


int luaopen_lua_m_socket_http(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_http);
}


int luaopen_lua_m_socket_mbox(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_mbox);
}


int luaopen_lua_m_socket_smtp(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_smtp);
}


int luaopen_lua_m_socket_tp(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_tp);
}


int luaopen_lua_m_socket_url(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket_url);
}


int luaopen_lua_m_socket(lua_State *L) {
    return luaL_loadstring(L, lua_m_socket);
}
